...
def train_gesture_classification(config):
    ...
    model = CombinedModel(
        ...
        num_keypoints=16,  
        max_people=13,  
        gesture_layer_sizes=layer_sizes,
        gesture_dropout_rates=dropout_rates,
        gesture_activations=activations
)
    ...
    # Load your data here
    train_data = GestureDataset.GestureDataset(
    ...
    test_data = GestureDataset.GestureDataset(
...
search_space = {
    ...
    "lr_scheduler_type": tune.choice(['StepLR', 'ExponentialLR', 'CosineAnnealingLR']),
...
train_gesture_classification_with_resources = tune.with_resources(
